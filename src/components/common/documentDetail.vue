<template>
  ...
  >
<!--    <van-icon name="plus" size="20" class="icon" />-->
    <div style="margin: 0 auto;display: flex;align-items: center">
      <img style="width: 18px;height: 18px" src="@/assets/img/home/more.png" alt />
    </div>
  </div>
</template>
...
export default {
  ...
  watch: {
    ...
    //     // console.log("watch中draftData", val);
    //   }
    // }
  },
  data() {
  ...
  methods: {
    funDetail() {
      // console.log("我执行了的")
      bus.$emit("show", 1, this.draftData);
      // this.$emit("getDraftsData", true);
    },
