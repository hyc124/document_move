<template>
  <div style="background-color: #FFFFFF">
    ...
    <div v-if="record.ids.length>0" class="sync" @click="goBack">
    ...
    <div calss="content">
      ...
      >
        ...
        <van-tab title="收发文单位" name="3" v-if="type!=1">
          <receiving
            v-if="nodata_label"
            @nodataLabel="nodataLabel"
            @stratum="stratum"
...
<script>
import Organize from "@/components/depUser/components/organize.vue";
import Countermark from "@/components/depUser/components/countermark.vue";
import receiving from "@/components/depUser/components/receiving.vue";
