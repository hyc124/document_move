    ...
    <div class="choise">
      ...
      <div class="level">
        <van-field
          @change="changeText()"
          label="主送单位"
          v-model="document_arr.main_delivery"
          placeholder="请输入主送单位"
          input-align="right"
          :border="false"
          rows="1"
    ...
    <div class="choise">
      ...
      <div class="level">
        <van-field
          @change="changeText()"
          label="抄送人/单位"
          v-model="document_arr.copy_users"
          placeholder="请输入抄送人/单位"
          input-align="right"
          :border="false"
          rows="1"
          autosize
    ...
    <van-popup v-model="tableStatus">
      <div class="infoBox" @click="tableStatus=false">
        ...
        <table align="center" cellspacing="0" cellpadding="6" border="1">
          <tbody>
            <tr align="center">
              <td height="44px">签报标题</td>
              <td colspan="3">{{document_arr.title}}</td>
            </tr>
            <tr align="center">
              <td height="44px">签报字号</td>
...
export default {
  ...
  methods: {
    //文字变化就改变 点了立即审核就传过去
    changeText() {
      // console.log(this.document_arr, "this.document_arrthis.document_arr");
    ...
    nextStep() {
      // this.addList = [];
      // console.log( this.document_arr,' this.docContent');
